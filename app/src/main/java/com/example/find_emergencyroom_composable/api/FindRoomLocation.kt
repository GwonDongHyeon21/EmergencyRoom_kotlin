...
fun findLocation(phId: String, room: EmergencyRoom) {
    try {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8") + "=osSbKZNKbmiohBJJZSqgOHWLkhZr9oBYEiHOR9OGOJvG6KDEnXRi4zgGiVnFnprotX7QIIMlgr1%2FCKDCaVLmDQ%3D%3D") /*Service Key*/
